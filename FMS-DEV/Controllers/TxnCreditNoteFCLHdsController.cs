...
{
    public class TxnCreditNoteFCLHdsController : Controller
    {
        ...
        public TxnCreditNoteFCLHdsController(FtlcolombOperationContext context, FtlcolomboAccountsContext accountsContext)
        {
            _context = context; 
        ...
        public IActionResult Create(string searchString)
        {
            ...
            var tables = new CreditNoteFCLViewModel
            {
                CreditNoteFCLHdMulti = _context.TxnCreditNoteFCLHds.Where(t => t.CreditNoteNo == "xxx"),
                CreditNoteFCLDtlMulti = _context.TxnCreditNoteFCLDtls.Where(t => t.CreditNoteNo == "xxx"),
        ...
        public async Task<IActionResult> Create(string dtlItemsList, [Bind("CreditNoteNo,Date,JobNo,Customer,ExchangeRate,TotalCreditAmountLkr,TotalCreditAmountUsd,Remarks,CreatedBy,CreatedDateTime,LastUpdatedBy,LastUpdatedDateTime,Canceled,Approved,Type, AmountPaid,AmountToBePaid, AgentID")] TxnCreditNoteFCLHd txnCreditNoteFCLHd)
        {

            // Next RefNumber for txnFCLJobDtl
            var nextRefNo = "";
            var TableID = "Txn_CreditNoteHD_FCL";
            ...
            if (refLastNumber != null)
            {
                ...
                txnCreditNoteFCLHd.CreditNoteNo = nextRefNo;
            ...
            txnCreditNoteFCLHd.Canceled = false;
            txnCreditNoteFCLHd.Approved = false;
            txnCreditNoteFCLHd.CreatedBy = "Admin";
            txnCreditNoteFCLHd.CreatedDateTime = DateTime.Now;

            txnCreditNoteFCLHd.AmountPaid = 0;
            txnCreditNoteFCLHd.AmountToBePaid = txnCreditNoteFCLHd.TotalCreditAmountLkr;

            var LocalOverseas = txnCreditNoteFCLHd.Type;
            ...
            {
                txnCreditNoteFCLHd.CreditAcc = "ACC0067"; // LOCAL CREDITORS  1200-02	
                TransDocVender = "Liner";

            }
            else // Oversease
            {
                txnCreditNoteFCLHd.CreditAcc = "ACC0068"; // OVERSEAS CREDITORS	  1200-03	
                TransDocVender = "Agent";
                txnCreditNoteFCLHd.Type = "Overseas"; // There is an error in the create if the Selection is "Overseae" Type not pass. This is  a temporary solution. 

            }

            txnCreditNoteFCLHd.DebitAcc = null;
            ...
            if (ModelState.IsValid)
            {
                ...
                _context.Add(txnCreditNoteFCLHd);
        ...
        {
            if (id == null || _context.TxnCreditNoteFCLHds == null)
            {
                return NotFound();
            }

            var txnCreditNoteHd = await _context.TxnCreditNoteFCLHds.FindAsync(id);
            ...
            var tables = new CreditNoteFCLViewModel
            {
                CreditNoteFCLHdMulti = _context.TxnCreditNoteFCLHds.Where(t => t.CreditNoteNo == id),
                CreditNoteFCLDtlMulti = _context.TxnCreditNoteFCLDtls.Where(t => t.CreditNoteNo == id),
                FCLJobMulti = _context.TxnFCLJobs
                .Include(t => t.ShippingLineFCLJobExportNavigation)
        ...
        public async Task<IActionResult> Edit(string id, string dtlItemsList, [Bind("CreditNoteNo,Date,JobNo,Customer,ExchangeRate,TotalCreditAmountLkr,TotalCreditAmountUsd,Remarks,CreatedBy,CreatedDateTime,LastUpdatedBy,LastUpdatedDateTime,Canceled,Approved ,Type, AmountPaid,AmountToBePaid, AgentID")] TxnCreditNoteFCLHd txnCreditNoteHd)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    if (!string.IsNullOrWhiteSpace(dtlItemsList))
                    {
                        var rowsToDelete = _context.TxnCreditNoteFCLDtls.Where(t => t.CreditNoteNo == id);
                        if (rowsToDelete != null || rowsToDelete.Any())
                        {
                            // Remove the rows from the database context
                            _context.TxnCreditNoteFCLDtls.RemoveRange(rowsToDelete);
                        }
                        var DtailItemdataTable = JsonConvert.DeserializeObject<List<TxnCreditNoteFCLDtl>>(dtlItemsList);
                        if (DtailItemdataTable != null)
                        {
                            ...
                            foreach (var item in DtailItemdataTable)
                            {
                                ...
                                DetailItem.BlContainerNo = item.BlContainerNo;
                                DetailItem.AccNo = DetailItem.AccNo = CommonMethodAccClass.GetChargeItemAccNo(item.ChargeItem, TransDocMode, TransDocType, TransDocVender);
                                _context.TxnCreditNoteFCLDtls.Add(DetailItem);
                            }
                        }
                    }
        ...
        {
            return (_context.TxnCreditNoteFCLHds?.Any(e => e.CreditNoteNo == id)).GetValueOrDefault();
        }
        ...
        public async Task<IActionResult> Details(string id)
        {
            ...
            var txnCreditNoteFCLHd = await _context.TxnCreditNoteFCLHds
                .FirstOrDefaultAsync(m => m.CreditNoteNo == id);
            if (txnCreditNoteFCLHd == null)
            {
                return NotFound();
            }
            var jobNo = txnCreditNoteFCLHd.JobNo;

            //var tables = new CreditNoteFCLViewModel
            //{
            //    CreditNoteFCLHdMulti = await _context.TxnCreditNoteFCLHds.Where(t => t.CreditNoteNo == "xxx").ToListAsync(),
            //    CreditNoteFCLDtlMulti = await _context.TxnCreditNoteFCLDtls.Where(t => t.CreditNoteNo == "xxx").ToListAsync(),
            ...
            var tables = new CreditNoteFCLViewModel
            {
                CreditNoteFCLHdMulti = await _context.TxnCreditNoteFCLHds
        .Where(t => t.CreditNoteNo == id) // Change "xxx" to "id"
        .ToListAsync(),
                CreditNoteFCLDtlMulti = await _context.TxnCreditNoteFCLDtls
        .Where(t => t.CreditNoteNo == id) // Change "xxx" to "id"
        .ToListAsync(),
                FCLJobMulti = await _context.TxnFCLJobs
        .Include(t => t.ShippingLineFCLJobExportNavigation)
        ...
        public async Task<IActionResult> Approve(string id)
        {
            ...
            var txnCreditNoteHds = await _context.TxnCreditNoteFCLHds
                .FirstOrDefaultAsync(m => m.CreditNoteNo == id);
        ...
        public async Task<IActionResult> Approve(string id, bool approved)
        {
            ...
            var txnCreditNoteFCLDtls = await _context.TxnCreditNoteFCLDtls
            ...
            if (txnCreditNoteFCLDtls != null)
            {
                ...
                NewRowAccTxnFirst.DocType = "CreditNTFCL";
                ...
                foreach (var item in txnCreditNoteFCLDtls)
                {
                    ...
                    NewRowAccTxn.DocType = "CreditNTFCL";
        ...
        public async Task<IActionResult> RepPrintCreditNote(string CreditNoteNo)
        {
            ...
            var txnCreditNoteHd = await _context.TxnCreditNoteFCLHds
            ...
            var tables = new CreditNoteFCLViewModel
            {
                CreditNoteFCLHdMulti = _context.TxnCreditNoteFCLHds.Include(c => c.ShippingLineCreditNoteFCLNavigation)
                .Include(a => a.AgentCreditNoteFCLNavigation).Where(t => t.CreditNoteNo == CreditNoteNo),
                CreditNoteFCLDtlMulti = _context.TxnCreditNoteFCLDtls.Include(c => c.ChargeItemNavigation).Where(t => t.CreditNoteNo == CreditNoteNo),
                FCLJobMulti = _context.TxnFCLJobs
                .Include(t => t.ShippingLineFCLJobExportNavigation)
               .Where(t => t.JobNo == jobNo),
            };

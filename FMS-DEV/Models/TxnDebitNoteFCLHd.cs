...
[Table("Txn_DebitNoteHD_FCL")]
public partial class TxnDebitNoteFCLHd
{
    [Key]
    [StringLength(20)]
    ...
    [ForeignKey("AgentID")]
    [InverseProperty("TxnDebitNoteFCLHd")]
    public virtual RefAgent? AgentDebitNoteFCLNavigation { get; set; }

    //[ForeignKey("Customer")] // Shippingline
    //[InverseProperty("TxnDebitNoteExportHd")]
    //public virtual RefShippingLine? ShippingLineDebitNoteExpNavigation { get; set; }

    [ForeignKey("Customer")] // Shippingline
    [InverseProperty("TxnDebitNoteFCLHd")]
    public virtual RefShippingLine? ShippingLineDebitNoteFCLNavigation { get; set; }
}

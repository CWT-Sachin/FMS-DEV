...
[Table("Txn_PaymentVoucherHD_FCL")]
public partial class TxnPaymentVoucherFCLHd
{
    [Key]
    [StringLength(20)]
    ...
    [ForeignKey("AgentID")]
    [InverseProperty("TxnPaymentVoucherFCLHd")]
    public virtual RefAgent? AgentPaymentVoucherFCLNavigation { get; set; }

    [ForeignKey("Customer")] // Shippingline
    [InverseProperty("TxnPaymentVoucherFCLHd")]
    public virtual RefShippingLine? ShippingLinePaymentVoucherFCLNavigation { get; set; }
}

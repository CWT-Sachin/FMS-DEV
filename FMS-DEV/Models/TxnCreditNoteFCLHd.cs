...
[Table("Txn_CreditNoteHD_FCL")]
public partial class TxnCreditNoteFCLHd
{
    [Key]
    [StringLength(20)]
    ...
    [ForeignKey("AgentID")]
    [InverseProperty("TxnCreditNoteFCLHd")]
    public virtual RefAgent? AgentCreditNoteFCLNavigation { get; set; }
    ...
    [ForeignKey("Customer")] // Shippingline
    [InverseProperty("TxnCreditNoteFCLHd")]
    public virtual RefShippingLine? ShippingLineCreditNoteFCLNavigation { get; set; }
}
